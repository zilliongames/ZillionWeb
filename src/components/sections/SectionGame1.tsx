      ...
      <div ref={ref} className="relative w-full max-w-[1100px] mx-auto px-6 md:px-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
        ...
        <motion.div initial={{ opacity: 0, x: 50 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.8, delay: 0.2 }} className="w-full lg:w-1/2">
          <div style={{ background: "rgba(0,0,0,0.35)", padding: "40px", borderRadius: "24px", border: "1px solid rgba(255,255,255,0.1)", boxShadow: "0 0 40px rgba(0,0,0,0.5)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", textAlign: "center" }}>
            ...
            <div className="mb-6">
              <span className="text-[14px] font-bold text-[#b4adff]">2D 픽셀 RPG / 방치형 액션</span>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <a href="https://play.google.com/store/apps/details?id=com.zilliongames.hunteridle" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-3 px-10 py-[22px] rounded-full bg-gradient-to-r from-[#6C63FF] to-[#00D4FF] text-white text-[16px] font-bold hover:shadow-[0_0_40px_rgba(108,99,255,0.5)] hover:scale-[1.05] transition-all duration-300">
              ...
              <a href="https://apps.apple.com/kr/app/%ED%94%BD%EC%85%80-%ED%97%8C%ED%84%B0-%ED%82%A4%EC%9A%B0%EA%B8%B0-%EB%B0%A9%EC%B9%98%ED%98%95-rpg/id1664366717" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-3 px-10 py-[22px] rounded-full bg-white text-black text-[16px] font-bold hover:bg-gray-100 hover:scale-[1.05] transition-all duration-300 shadow-lg">
