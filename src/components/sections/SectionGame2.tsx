      ...
      <div ref={ref} className="relative w-full max-w-[1100px] mx-auto px-6 md:px-10 flex flex-col lg:flex-row-reverse items-center gap-8 lg:gap-16">
        ...
        <motion.div initial={{ opacity: 0, x: -50 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.8, delay: 0.2 }} className="w-full max-w-[500px] lg:max-w-none lg:w-1/2">
          <div style={{ background: "rgba(0,0,0,0.35)", padding: "40px", borderRadius: "24px", border: "1px solid rgba(255,255,255,0.1)", boxShadow: "0 0 40px rgba(0,0,0,0.5)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", textAlign: "center" }}>
            <a href="https://abr.ge/4le7ch" target="_blank" rel="noopener noreferrer" className="flex justify-center mb-8">
              <Image
            ...
            <div className="mb-6">
              <span className="text-[14px] font-bold text-[#DDD6FE]">전략 / 영웅 수집 RPG</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a href="https://play.google.com/store/apps/details?id=com.zilliongames.collectionidle" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-3 px-6 py-[18px] min-w-[160px] rounded-full bg-gradient-to-r from-[#C084FC] to-[#93C5FD] text-white text-[16px] font-bold hover:shadow-[0_0_40px_rgba(192,132,252,0.5)] hover:scale-[1.05] transition-all duration-300">
              ...
              <a href="https://apps.apple.com/kr/app/%EC%8A%A4%EC%9C%84%EC%B9%AD-%ED%9E%88%EC%96%B4%EB%A1%9C%EC%A6%88-%ED%82%A4%EC%9A%B0%EA%B8%B0-rpg/id6473819116" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-3 px-6 py-[18px] min-w-[160px] rounded-full bg-white text-black text-[16px] font-bold hover:bg-gray-100 hover:scale-[1.05] transition-all duration-300 shadow-lg">
